import 'package:class_talk/Screens/HomeScreen.dart';
import 'package:class_talk/Screens/NewRegistration.dart';
      ...
      child: ListView(
        ...
        children: [
          ...
          DrawerListTile(
            ...
            onTap: () {
              // Navigator.push(context,
              //     MaterialPageRoute(builder: (context) => ClassChatScreen()));
            },
          ),
          DrawerListTile(
